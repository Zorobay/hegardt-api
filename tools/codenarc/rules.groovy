def defOkRegex = '*Controller, BootStrap'
def noFieldTypeMethodRegex = 'triggers, mapping, constraints'
...
ruleset {
    ...
    FieldTypeRequired {
        ignoreFieldNames = noFieldTypeMethodRegex
    }
    HashtableIsObsolete
    ...
    MethodReturnTypeRequired {
        doNotApplyToClassNames = defOkRegex
    }
    NoDef {
        doNotApplyToClassNames = defOkRegex
    }
